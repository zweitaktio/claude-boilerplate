...
target: graph
domain: routing
tags: [loader, data-loading, clientLoader, streaming, defer, await]
---
...
- Child loaders **cannot** access parent loader data during execution
- Auth redirects in parent still protect child routes (redirect short-circuits rendering)
- Use `useOutletContext()` or `useRouteLoaderData()` for component-level sharing
