...
tags: [action, forms, Form, useFetcher, mutations, submit]
---
...
- Automatic rollback — if action fails, loaders revalidate and reset
...
// fetcher.data is now typed from action return
```
