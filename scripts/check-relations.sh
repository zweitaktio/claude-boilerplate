...
[
  ...
  {from: "VendorReactRouter8I18nSetup",  to: "VendorReactRouter8Routing", type: "integrates_with"},
  {from: "VendorReactRouter8I18nUsage",  to: "VendorReactRouter8Routing", type: "integrates_with"},
  {from: "VendorReactRouter8I18nOperations",  to: "VendorReactRouter8Routing", type: "integrates_with"},
